...
\cleardoublepage
\chapter*{Kurzfassung}
Der Smartphone-Sektor wächst seit dem Anfang des 21. Jahrhunderts rasant an. Die Anwendungsbereiche in denen unsere Smartphones integriert sind breitgefächerter als je und sie sind ein wichtiger Aspekt unseres Lebens geworden. Aufgrund dieses Wachstums und weil unsere Handys wahre multifunktionale Geräte geworden sind, steigt auch die Hardware Anforderungen, welche wir an die Geräte stellen. Sie besitzen nicht mehr lediglich eine Kamera und eine Musik App, sondern die Bandbreite an Applikationen die zur Verfügung stehen ist sehr groß. Von simplen Apps wie einem Timer hin zu Apps, welche ein komplexes UI haben mit mehreren Fenstern und Animationen. Das bedeutet gleichzeitig, dass die Anforderungen an die Entwickler der Apps auch steigen. Es werden kürzere Entwicklungszyklen erwartet, um ein Produkt von der Konzeption der Idee bis zur Marktreife zu bekommen. Aufgrund dessen müssen auch die Werkzeuge, um Apps zu entwickeln sich auf weiterentwickeln. Der bisherige Status quo der Android App Entwicklung war ein imperativer Ansatz, welcher sehr viel selbst schreiben und genaues Definieren der einzelnen Komponenten bedeutet. Google hat mit dem Framework Jetpack Compose auf eine neue Art der Entwicklung gesetzt, die sich deklaratives Programmieren nennt. Hier beschreiben die Entwickler was sie wollen und das Framework regelt den Großteil im Hintergrund. Um einen simplen Button zu erstellen zum Beispiel, werden keine 2-3 Dateien mehr benötigt, sondern nur wenige Codezeilen. Jetpack Compose verspricht es Entwicklungszyklen zu minimieren, moderne Apps schneller zu schreiben und gleichzeitig eine saubere Code-Architektur zu behalten.
